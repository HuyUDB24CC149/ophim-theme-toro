...
namespace Ophim\ThemeToroFix\Controllers;
...
class ThemeToroFixController
{
    ...
    public function index(Request $request)
    {
        ...
        if ($keyword || $request['filter']) {
            ...
            return view('themes::themetorofix.catalog', [
                'movies' => $data,
                'search' => $keyword,
        ...
        return view('themes::themetorofix.index', compact('title', 'movies_latest', 'home_page_slider_poster', 'home_page_slider_thumb'));
    }
    ...
    public function getMovieOverview(Request $request)
    {
        ...
        return view('themes::themetorofix.single', [
            'currentMovie' => $movie,
            'title' => $movie->name,
    ...
    public function getEpisode(Request $request)
    {
        ...
        return view('themes::themetorofix.episode', [
            'currentMovie' => $movie,
            'movie_related' => $movie_related,
            'episode' => $episode,
    ...
    public function watchVideo(Request $request)
    {
        ...
        return view('themes::themetorofix.video', [
            'currentMovie' => $movie,
            'movie_related' => $movie_related,
            'video' => $video,
            'title' => $movie->name
