...
class ThemeToroFixServiceProvider extends ServiceProvider
{
    ...
    {
        view()->composer('themes::themetorofix.layout', function ($view) {
        ...
        view()->composer('themes::themetorofix.inc.header', function ($view) {
        ...
        view()->composer('themes::themetorofix.inc.rightbar', function ($view) {
        ...
        view()->composer('themes::themetorofix.inc.footer', function ($view) {
        ...
        $this->publishes([
            __DIR__ . '/../resources/assets' => public_path('themes/torofix')
        ], 'torofix-assets');
    }
    ...
    protected function setupDefaultThemeCustomizer()
    {
        config(['themes' => array_merge(config('themes', []), [
            'torofix' => [
                'name' => 'Theme Toro Fix',
                'author' => 'HuyUDB24CC149',
                'package_name' => 'HuyUDB24CC149/ophim-theme-toro-fix',
                'publishes' => ['torofix-assets'],
                'preview_image' => '',
                'options' => [
                    [
                        'name' => 'per_page_limit',
